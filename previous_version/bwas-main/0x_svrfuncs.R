...
###SVR functions for BWAS analyses run via cluster#####
###wrapper functions built around e1071 libary 
###note local system-specifc library loadings
###See 01_SVRbysample size for example call
