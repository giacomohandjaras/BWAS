...
Code (as well as matlab workspaces) is available also here: https://osf.io/2szkv/ <br>
...
<i>inflation_effect_parent_script.m:</i> code to assess effect size inflation across multiple statistical thresholds (Figure 2D)<br><br>
<i>sample_adjustment_parent_script.m:</i> code to demonstrate that effect sizes reported in the literature align with true effects measured in the population only when the sample size is large enough (Figure 2E-F)<br><br>
<i>count_powered_correlations.m:</i> count multiple univariate brain-behavior associations with ≥ 80% statistical power (Figure 2B)<br><br>
<i>multivariate_cca_power.m:</i> code to assess power calculations with multivariate canonical correlation (Figure 2C)<br><br>
